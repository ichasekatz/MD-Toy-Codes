...
temp1 =[]
error = []
filename = f'{file_name}Research/MD/Force/SiC-Tension/Outputs_Press/npt300K1bar.cnt'
log_file = filename
...
while i <= 10:
    temp += [(i*2500)/10000]
    temp1 += [i*2500]
    filename = f'{file_name}Research/MD/Force/SiC-Tension/Outputs_Press/npt300K{temp1[i-1]}bar.eql'
    log_file = filename
