...
# -*- coding: utf-8 -*-
"""
Created on Wed Oct 23 10:57:14 2024
...
while i <= 10:
    temp += [i*2500]
    filename = f'{file_name}Research/MD/Force/SiC-Tension/Outputs_Shear/npt300Kxy{temp[i-1]}bar.eql'
    log_file = filename
...
plt.plot(temp, avg, label='Bulk Modulus', marker='o', color='b')
...
for i in range(len(temp)):
    print('|Press:',temp[i],'bars |Volume:',avg[i],'A^3 |Error:+-',error[i],'|')
